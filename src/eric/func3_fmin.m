...
tp_eq=1;te_eq=1;
[time, y_equilib, conc, conc2]=func2_TimeCourse(params,initial_conditions,0,[1,1], ...
...
[time, y_vals, conc, conc2]=func2_TimeCourse(params,initial_conditions2,...
                                             EGF_conc(exp),inhib,time_course,te,tp,conc, conc2);
